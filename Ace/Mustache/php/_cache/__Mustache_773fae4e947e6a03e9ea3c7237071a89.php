...
class __Mustache_773fae4e947e6a03e9ea3c7237071a89 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '					<th><i class="icon-time bigger-110 hidden-480"></i> Update</th>';
        $buffer .= "\n";
        ...
        $buffer .= $this->sectionEd771cdebdb3b408c028d8760dfc0393($context, $indent, $context->findDot('page.domains1'));
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '		</table>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '	<i class="icon-hand-right icon-animated-hand-pointer blue"></i>';
        $buffer .= "\n";
    ...
    private function sectionEd771cdebdb3b408c028d8760dfc0393(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
