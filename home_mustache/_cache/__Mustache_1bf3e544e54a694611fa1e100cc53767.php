...
class __Mustache_1bf3e544e54a694611fa1e100cc53767 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section72cd247345b01bc4ed44596ce4a4438e($context, $indent, $context->findDot('page.domains2'));
        $buffer .= $indent . '';
        $buffer .= "\n";
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
    ...
    private function section72cd247345b01bc4ed44596ce4a4438e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
