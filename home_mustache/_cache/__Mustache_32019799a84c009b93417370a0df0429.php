...
class __Mustache_32019799a84c009b93417370a0df0429 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			';
        $value = $this->resolveValue($context->findDot('user_menu.user_email'), $context, $indent);
