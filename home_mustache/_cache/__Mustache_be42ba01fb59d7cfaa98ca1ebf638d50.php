...
class __Mustache_be42ba01fb59d7cfaa98ca1ebf638d50 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '								<li><i class="icon-caret-right blue"></i> Nested List Item</li>';
        $buffer .= "\n";
        $buffer .= $indent . '								<li><i class="icon-caret-right blue"></i> Nested List Item</li>';
        $buffer .= "\n";
        $buffer .= $indent . '								<li><i class="icon-caret-right blue"></i> Nested List Item</li>';
        ...
        $buffer .= "\n";
        $buffer .= $indent . '						<li><i class="icon-bell bigger-110 purple"></i> List with custom icons and more space</li>';
        $buffer .= "\n";
        $buffer .= $indent . '						<li><i class="icon-ok bigger-110 green"></i> Unordered List Item # 2</li>';
        $buffer .= "\n";
        $buffer .= $indent . '						<li><i class="icon-remove bigger-110 red"></i> Unordered List Item # 3</li>';
        $buffer .= "\n";
        $buffer .= $indent . '					</ul>';
        $buffer .= "\n";
        $buffer .= $indent . '					<ul class="list-unstyled spaced2">';
        $buffer .= "\n";
        $buffer .= $indent . '						<li><i class="icon-circle green"></i> Even more space</li>';
        $buffer .= "\n";
        $buffer .= $indent . '						<li class="text-warning bigger-110 orange"><i class="icon-warning-sign"></i> Unordered List Item # 5</li>';
        $buffer .= "\n";
        $buffer .= $indent . '						<li class="muted"><i class="icon-angle-right bigger-110"></i> Unordered List Item # 6</li>';
        $buffer .= "\n";
        $buffer .= $indent . '						<li>';
        $buffer .= "\n";
        $buffer .= $indent . '							<ul class="list-inline">';
        $buffer .= "\n";
        $buffer .= $indent . '								<li><i class="icon-share-alt green bigger-110"></i> Inline List Item # 1</li>';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '			<div class="widget-header widget-header-flat">';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4 class="smaller"><i class="icon-quote-left smaller-80"></i> BlockQuote & Address</h4>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= $indent . '			';
        ...
        $buffer .= $indent . '			<div class="widget-header widget-header-flat">';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4 class="smaller">Definition List</h4>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '						<input id="id-check-horizontal" type="checkbox" class="ace ace-switch ace-switch-6" /><span class="lbl"></span>';
        $buffer .= "\n";
        $buffer .= $indent . '					</label>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
        ...
        $buffer .= $indent . '				<div class="widget-header widget-header-flat">';
        $buffer .= "\n";
        $buffer .= $indent . '					<h4 class="smaller"><i class="icon-code"></i> Code view</h4>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
        $buffer .= "\n";
        $buffer .= $indent . '				<div class="widget-body">';
