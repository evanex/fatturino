...
class __Mustache_268cbc420dcc2b960815aec57ff94593 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB90ae0bc8e61076b25b7699589b2c22c($context, $indent, $context->findDot('page.invoices'));
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '		</table>';
        $buffer .= "\n";
    ...
    private function sectionB90ae0bc8e61076b25b7699589b2c22c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
