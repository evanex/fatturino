...
class __Mustache_62bfb10847c2c86ce41b828723eea66f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section63fc78f39ebad200f1467e9af56a860a($context, $indent, $context->findDot('page.domains2'));
        $buffer .= $indent . '';
        $buffer .= "\n";
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
    ...
    private function section63fc78f39ebad200f1467e9af56a860a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
