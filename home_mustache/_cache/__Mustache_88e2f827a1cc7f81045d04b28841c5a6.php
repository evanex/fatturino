...
class __Mustache_88e2f827a1cc7f81045d04b28841c5a6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section419117ed962fb4662f3a09ccac8bc4cc($context, $indent, $context->findDot('page.invoices'));
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '		</table>';
        $buffer .= "\n";
    ...
    private function section419117ed962fb4662f3a09ccac8bc4cc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                $buffer .= $indent . '						<label><input type=\'checkbox\' class="ace" id=\'fatt_id_{id}\' /><span class="lbl"></span></label>';
                $buffer .= "\n";
                $buffer .= $indent . '					</td>';
                $buffer .= "\n";
