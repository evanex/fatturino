...
class __Mustache_57d531dd30a4511f95826e5c7a0f7a10 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '				<tr>';
        $buffer .= "\n";
        $buffer .= $indent . '					<th class="center sorting_disabled" role="columnheader"></th>';
        $buffer .= "\n";
        ...
        $buffer .= $this->section156e75fbcabf5fb7e56bec61f4055faf($context, $indent, $context->findDot('page.invoices'));
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '		</table>';
        $buffer .= "\n";
    ...
    private function section156e75fbcabf5fb7e56bec61f4055faf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
