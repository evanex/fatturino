...
class __Mustache_920b59b364a3fb35e36c836e52715a54 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB0ed26d9cf60db0c311aba166923a9a0($context, $indent, $context->findDot('page.invoices'));
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '		</table>';
        $buffer .= "\n";
    ...
    private function sectionB0ed26d9cf60db0c311aba166923a9a0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
				<tr>
					<td class=\'center\'>
					<!--	
						<label><input type=\'checkbox\' class="ace" id=\'fatt_id_{{id}}\' /><span class="lbl"><a href=\'#\'>{{num_fatt}}</a></span></label>
					-->
					</td>
					<td class=\'center\' ><a href=\'#\'>{{num_fatt}}</a></td>
					<td>{{data}}</td>
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '					</td>';
                $buffer .= "\n";
                $buffer .= $indent . '					<td class=\'center\' ><a href=\'#\'>';
                $value = $this->resolveValue($context->find('num_fatt'), $context, $indent);
                $buffer .= htmlspecialchars($value, ENT_COMPAT, 'UTF-8');
                $buffer .= '</a></td>';
                $buffer .= "\n";
