...
class __Mustache_c892600d41ddecf7d56a9c93f713d845 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4def6353c755e1430dfb8856438d25f7($context, $indent, $context->findDot('page.invoices'));
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '		</table>';
        $buffer .= "\n";
    ...
    private function section4def6353c755e1430dfb8856438d25f7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
				<tr>
					<td class=\'center\'>
						...
						<label><span class="lbl"><a href=\'#\'>{{num_fatt}}</a></span></label>
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '						';
                $buffer .= "\n";
                $buffer .= $indent . '						<label><span class="lbl"><a href=\'#\'>';
