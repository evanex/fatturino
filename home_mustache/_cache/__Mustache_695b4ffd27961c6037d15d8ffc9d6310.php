...
class __Mustache_695b4ffd27961c6037d15d8ffc9d6310 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9a390f38d41d854a9c2fd39278d4d653($context, $indent, $context->findDot('page.invoices'));
        $buffer .= $indent . '			</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '		</table>';
        $buffer .= "\n";
    ...
    private function section9a390f38d41d854a9c2fd39278d4d653(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
